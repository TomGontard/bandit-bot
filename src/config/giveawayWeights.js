...
module.exports = {
  ...
  registrationMultipliers: [
    { min:   0, max: 100, weight: 1.7 },
    { min: 101, max: 200, weight: 1.6 },
    { min: 201, max: 300, weight: 1.5 },
    { min: 301, max: 400, weight: 1.4 },
    { min: 401, max: 500, weight: 1.3 },
    { min: 501, max: 600, weight: 1.2 },
    { min: 601, max: 700, weight: 1.1 },
    { min: 701, max: 800, weight: 1 },
  ]
};
