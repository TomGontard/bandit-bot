...
export const data = new SlashCommandBuilder()
  ...
  .addSubcommand((sub) =>
    sub
      ...
      .addIntegerOption((opt) =>
        opt.setName('amount').setDescription('Number of whitelists to add').setRequired(true)
      )
      .addStringOption((opt) =>
        opt.setName('reason').setDescription('Reason for adding').setRequired(true)
      )
  )
  .addSubcommand((sub) =>
    sub
      ...
      .addIntegerOption((opt) =>
        opt.setName('amount').setDescription('Number of whitelists to remove').setRequired(true)
      )
      .addStringOption((opt) =>
  ...
  .addSubcommand((sub) =>
    sub.setName('total').setDescription('Show total whitelists (Admin only)')
  );
